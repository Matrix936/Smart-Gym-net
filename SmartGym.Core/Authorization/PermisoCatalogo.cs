...
public static class PermisoCatalogo
{
    ...
    public const string PromocionesGestionar = "promociones.gestionar";
    ...
    [
        ...
        PosVender, PosCancelarVenta, PosVerHistorial, ProductosGestionar, PromocionesGestionar, MaquinariaGestionar,
        FinanzasVer,
        ConfiguracionEditar,
