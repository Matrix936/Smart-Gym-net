...
/// 30 tablas, 20 triggers de updated_at, 30 índices idx_*, seed mínimo.
...
public sealed class DbSchemaTests
{
    ...
    [Fact]
    public void Schema_tiene_30_indices_con_prefijo_idx()
    {
        var indexes = Count(_fixture.DbPath, "type = 'index' AND name LIKE 'idx_%'");
        Assert.Equal(30, indexes);
    }
